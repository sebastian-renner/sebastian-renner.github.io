...
20146 Hamburg, Germany             & \textit{E-mail:} \email{sebastian.renner@uni-hamburg.de}\\
                             &   \\                                                   
\end{tabular}
Website: \url{https://sites.google.com/view/sebastianrenner} \\
...
Heat and Firm Productivity: Evidence from Indonesia's Manufacturing Sector, with Filippo Pavanello and Enrica de Cian \\

Vertical and Horizontal Equity of Carbon Taxes under Imperfect Targeting, with Oskar Lecuyer, Adrien Vogt-Schilb, Germán David Romero Otálora and Hauke Ward\\

Land Use Change, Land Markets and Ecosystem Services in Indonesia, with Sebastian Fiedler, Kerstin Wiegand and Jann Lay\\  
